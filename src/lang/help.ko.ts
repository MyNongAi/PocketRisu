...
export const helpKo = {
        ...
        "autoDeactivateAfterDays": "PocketRisu 서버에서 이 기간 동안 열지 않은 캐릭터를 메인 DB에서 빼고 복구 가능한 서버 보관함으로 옮깁니다. 0이면 꺼집니다. 즐겨찾기·현재 캐릭터·생성 중인 캐릭터·휴지통·마지막으로 연 시각이 확실하지 않은 캐릭터는 제외합니다. 자동 비활성화된 캐릭터는 다시 열면 추가 확인 없이 활성화됩니다.",
