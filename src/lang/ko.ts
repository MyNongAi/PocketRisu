...
export const languageKorean = {
  ...
  supportDesc: "PocketRisu는 혼자 유지보수하는 오픈소스 포크입니다. 후원금은 서버·개발 비용에 쓰이며, 후원 혜택은 아래 후원자 목록에 이름이 표시되는 것뿐입니다.",
  supportButton: "Patreon에서 후원하기",
  supportSetName: "이름 등록",
  supportSetNameDesc: "후원 후 '이름 등록'에서 Patreon 로그인으로 표시할 이름을 직접 정할 수 있습니다. 비워두면 Patreon 이름이 쓰이고, 목록에서 숨길 수도 있습니다.",
  supportCount: "후원자 {n}명",
  supportTabMembers: "멤버십",
  supportTabLifetime: "누적 후원",
  supportPerMonth: "월",
  supportEmpty: "아직 후원자가 없습니다. 첫 번째가 되어주세요!",
  supportFormerNote: "흐린 이름은 이전 후원자입니다. 후원해 주셨던 마음은 계속 남습니다.",
  supportLoadFailed: "후원자 목록을 불러오지 못했습니다.",
  supportRetry: "다시 시도",
  supportDisabled: "이 서버는 업데이트 확인이 꺼져 있어 후원자 목록을 표시하지 않습니다.",
  supportUpstream: "PocketRisu는 RisuAI의 포크입니다. 원본 RisuAI 후원하기",
