...
export const languageEnglish = {
    ...
    branchGraphTree: "Tree",
    branchGraphTimeline: "Timeline",
    branchGraphAll: "All",
    branchGraphSmart: "Smart",
    branchGraphBranches: "Branches",
    branchGraphCollapsed: "collapsed",
    branchGraphFocus: "Focus Active",
    branchGraphChats: "chats",
    branchGraphMessages: "messages",
    branchGraphHighlightActive: "Highlight active path",
    importFromProton: "Import from Proton Drive",
    importFromProtonDesc: "Paste a Proton Drive share link to import",
    protonDriveUrlPrompt: "Paste Proton Drive share link",
    protonImporting: "Downloading from Proton Drive...",
