...
export const languageEnglish = {
    ...
    errors: {
        ...
        chatBodyMissing: "This chat's contents were not found on the server. It was kept unchanged to prevent an empty save from overwriting recoverable messages. Check another device or a backup.",
        chatBodyRetry: "Retry loading chat",
    ...
    importProgress: {
        ...
        readingCharx: "Reading CharX",
        readingPng: "Reading PNG",
        savingAssets: "Saving assets",
        savingEmbeddedAssets: "Saving embedded assets",
        savingProfileImage: "Saving profile image",
        savingEmotions: "Saving emotion images",
        savingAdditionalAssets: "Saving additional assets",
        savingVoiceAssets: "Saving voice assets",
        savingCardAssets: "Saving card assets",
        addingCharacter: "Adding character",
        readingPreset: "Reading preset",
        savingPreset: "Saving preset",
        readingModule: "Reading module",
        savingModule: "Saving module",
    },
    alwaysActive: "Always Active",
    ...
    createModuleFolder: "Create Module Folder",
    moveToModuleFolder: "Move to Folder",
    moduleFolderRoot: "No Folder",
    moduleFolderDeleteConfirm: "Delete this folder? Its modules will be kept in the main list.",
    moduleFolderContentsKept: "Folder deleted. Its modules were kept.",
    moduleEditTargetMissing: "The module no longer exists or is ambiguous. No changes were saved.",
    download: "Download",
    edit: "Edit",
    ...
    stealthAbsent: "No NAI stealth metadata — cannot be imported on novelai.net",
    stealthUnsupported: "Not an image, so there is nothing to check",
    stealthUnknown: "Could not read this asset's metadata",
    stealthChecking: "Checking metadata...",
    protonInspecting: "Reading the Proton link...",
    protonDownloading: "Downloading",
    protonImportAll: "Import all",
    protonBrowserTitle: "Proton folder",
    protonBrowserSelectAll: "Select all in this folder",
    protonBrowserSelected: (n: number) => `${n} selected`,
    protonBrowserImport: (n: number) => n > 0 ? `Import (${n})` : "Import",
    protonBrowserLoading: "Loading...",
    protonBrowserRetry: "Retry",
    protonBrowserEmpty: "This folder is empty",
    protonBrowserUnsupported: "Not an importable format",
    protonBrowserKind: {
        character: "Character",
        module: "Module",
        preset: "Preset",
    ...
    menu: "Menu",
    reloadApp: "Reload",
    reloadWhileGenerating: "A reply is still being generated. Reloading will stop it. Continue?",
    reloadBlockedUnsaved: "Some changes are not saved yet, so the app was not reloaded. Try again once saving finishes.",
    ...
    yumiImportDone: (created: number, main: string, updated = 0) => [
        ...
        main ? `Selected '${main}' as the model.` : '',
    ].filter(Boolean).join(' '),
    modelModeLockLabel: "Model mode setting",
    modelModeLockLegacy: "Use the model picker (default)",
    modelModeLockLegacyDesc: "Use the model chosen in the chat bot tab and sidebar model picker. Built-in models, plugins and model presets can all be picked there",
    modelModeLockPreset: "Lock to per-chat preset bindings",
