...
export const languageEnglish = {
    ...
    supportDesc: "PocketRisu is an open-source fork maintained by one person. Your support covers server and development costs. The only perk is your name in the supporter list below.",
    supportButton: "Support on Patreon",
    supportSetName: "Set name",
    supportSetNameDesc: "After supporting, use 'Set name' to sign in with Patreon and choose how you appear. Leave it blank to use your Patreon name, or hide yourself from the list.",
    supportCount: "{n} supporters",
    supportTabMembers: "Membership",
    supportTabLifetime: "Cumulative",
    supportPerMonth: "mo",
    supportEmpty: "No supporters yet. Be the first!",
    supportFormerNote: "Dimmed names are former supporters. Thank you for having been here.",
    ...
    supportUpstream: "PocketRisu is a fork of RisuAI. Support the original RisuAI",
