...
import { getModuleAssets, getModuleRegexScripts, getModules, type ModuleRuntimeContext } from "./modules";
...
export async function processScriptFull(
    ...
    // Script templates can introduce asset-list tokens after the initial
    // parse, so hydrate only the manifests referenced by this request.
